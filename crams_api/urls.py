...
from crams_api.views import RequestViewSet, ContactViewSet, ContactDetail, \
...
urlpatterns = [
    ...
    url(r'nectar_sps', lookup.nectar_storage_product),
    url(r'vicnode_sps', lookup.vicnode_storage_product),
