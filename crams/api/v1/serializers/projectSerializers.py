...
from crams.settings import PROJECT_SYSTEM_ID_INVALID_PREFIX_MAP
from crams.lang_utils import has_invalid_prefix
...
class ProjectIDSerializer(serializers.ModelSerializer):
    ...
    def validate_identifier_prefix(cls, identifier, system_obj):
        invalid_prefix_list = PROJECT_SYSTEM_ID_INVALID_PREFIX_MAP.get(
            system_obj.system.lower())
        if invalid_prefix_list and \
                has_invalid_prefix(identifier.lower(), invalid_prefix_list):
