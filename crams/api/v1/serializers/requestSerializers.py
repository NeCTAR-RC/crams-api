...
class CramsRequestSerializer(ActionStateModelSerializer):
    ...
    allocation_node = serializers.SlugRelatedField(
    ...
    class Meta(object):
        ...
        field = ('id', 'start_date', 'end_date', 'approval_notes', 'historic',
                 ...
                 'national_percent', 'allocation_node')
        read_only_fields = (
    ...
    def validate_allocation_percentage(
        ...
        if not crams_action_state.is_partial_action:
            if allocation_home_obj != request_obj.allocation_node or \
    ...
    def validate(self, data):
        ...
        allocation_home_obj = data.get('allocation_node')
        if not allocation_home_obj and instance:
            allocation_home_obj = instance.allocation_node
        if allocation_home_obj:
            data['allocation_node'] = allocation_home_obj
