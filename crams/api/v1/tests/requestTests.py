...
class RequestViewSetTest(CRAMSApiTstCase):
    ...
    def update_test_data_with_allocation_node_info(
            self, national_percent=100, allocation_node=None):
        ...
        for req in requests:
            ...
            req['allocation_node'] = allocation_node

    def validate_no_allocation_node_for_create(self, allocation_node):
        self.update_test_data_with_allocation_node_info(54, allocation_node)
        response = self._create_project_common(self.test_data,
    ...
    def validate_no_allocation_node_for_non_partial_update(
        ...
        self.update_test_data_with_allocation_node_info(65, allocation_node)
...
class NectarRequestTests(RequestViewSetTest):
    ...
    def test_no_allocation_node_for_create(self):
        super().validate_no_allocation_node_for_create(
            DBConstants.ALLOCATION_HOME_MONASH)

    def test_no_allocation_node_for_non_partial_update(self):
        super().validate_no_allocation_node_for_non_partial_update(
            DBConstants.ALLOCATION_HOME_MONASH)
